...
\textcolor{violet}{Un algoritmo è una sequenza finita di istruzioni che descrive come risolvere
...
\textcolor{violet}{Un albero è una struttura dati gerarchica utilizzata per rappresentare
...
\begin{itemize}
    \item \textcolor{orange}{\textbf{Definizione}}
    ...
    \item \textcolor{blue}{\textbf{Tipologie}}
    ...
    \item \textcolor{red}{\textbf{Applicazioni}}
